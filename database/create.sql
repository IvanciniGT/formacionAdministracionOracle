...
-- Hay un proceso en oracle, que es eel que se encarga de escribir a fichero los datos: DBWR (DataBase WRiter)
-- De ese proceso podemos tener varias instancias.
-- Por defecto usa un buffer de 8KB para escribir los bloques en disco el que viene cnfigurado.
-- Si queremos bloques de 32KB, además de configurar el parámetro DB_BLOCK_SIZE a 32768,
-- Es necesario tener un proceso especial DBWR que use bloques de 32KB (un buffer de 32KB)
